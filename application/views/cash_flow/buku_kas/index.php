              ...
              <div class="card">
                <div class="card-header border-0">
                  <div class="card-title">
                    <button type="button" class="btn bg-orange btn-kps btn-block btn-sm" id="btnTambahKas">
                      Tambah Kas
                    </button>
                  </div>
                </div>
...
<script type="text/javascript">
  $(document).ready(function(){
   ...
   var saveTransaksi = $('.saveTransaksi').ladda();
        ...
        $.ajax({
          ...
          success: function(data){
            ...
            if (inputTransaksi == '' || inputBiaya == '' || inputTujuan == '') {
              ...
              if (parseInt(data) == 1) {
                cekBukuKas(inputTransaksi, inputTujuan, inputBiaya, 'tambah')  
              }else{
    ...
    $('#getTabelKas').on('click','.btnUpdate', function(){
      $('#inputKodeApprove').val("");
      $('#modal-kas').modal("show")
    ...
    $('#getTabelKas').on('click', '.btnHapus', function(){
      var tujuan = $(this).attr("tujuan");
      var transaksi = $(this).attr("transaksi")
      var biaya = $(this).attr("biaya")
      var id = $(this).attr("data")
  ...
  function updateBukuKas(inputTransaksi, inputTujuan, inputBiaya, saldo) {
    ...
    $.ajax({
      type:'post',
      dataType:'json',
      data:{inputTransaksi, inputTujuan, inputBiaya, saldo, inputTujuanAwal, inputBiayaAwal, inputID},
      url:'updateBukuKas',
      cache: false,
      async: true,
      success:function(data){
  ...
  function cekBukuKas(inputTransaksi, inputTujuan, inputBiaya, jenis) {
    ...
    $.ajax({
      ...
      success: function(data){
        ...
        if (jenis == 'tambah') {
          ...
          totalSaldo = parseInt(saldo) + parseInt(inputBiayaAwal);
          if (totalSaldo < parseInt(inputBiaya) && inputTransaksi == 'Pinbuk') {
            Swal.fire("Saldo Modal Awal Tidak Cukup!","","warning")
          }else{
            updateBukuKas(inputTransaksi, inputTujuan, inputBiaya, saldo);
          }
        }
