                ...
                <div class="col-md-6">
                        ...
                        <div class="col-md-12" id="beforeNext">
                          <select class="select2 form-control select2-orange" data-dropdown-css-class="select2-orange" id="inputJenisSPJ">
                            <?php foreach ($spj as $spj): ?>
                              <option value="<?=$spj->ID_JENIS?>" <?=$spj->ID_JENIS == $key->JENIS_ID?'selected':'disabled'?>><?=$spj->NAMA_JENIS?></option>
                            <?php endforeach ?>
                          </select>
                        </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-7">
                      <div class="row">
                        <div class="col-md-12">
                          <input type="text" id="inputNoSPJ" class="form-control form-control-sm" value="<?=$key->NO_SPJ?>" readonly>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-7">
                      <div class="row">
                        <div class="col-md-12">
                          <input type="date" id="inputTglSPJ" class="form-control form-control-sm" value="<?=$key->TGL_SPJ?>">
                        </div>
                      </div>
                    </div>
                  </div>
                        ...
                        <div id="stepKendaraan" class="content" role="tabpanel" aria-labelledby="stepKendaraan-trigger">
                                ...
                                <div class="col-md-12">
                                  <select class="select2 form-control select2-orange" data-dropdown-css-class="select2-orange" id="inputKendaraan">
                                    <?php foreach ($kendaraan as $ken): ?>
                                      <option value="<?=$ken->Jenis?>" <?=$ken->Jenis == $key->KENDARAAN ? 'selected':''?>><?=$ken->Jenis?></option>
                                    <?php endforeach ?>
                                    <option value="Rental" <?=$key->KENDARAAN=='Rental' ? 'selected':''?>>Rental</option>
                                    <option value="Gojek/Grab" <?=$key->KENDARAAN=='Gojek/Grab' ? 'selected':''?>>Gojek/Grab</option>
                                  </select>
                                </div>
                              </div>
                            </div>
                                ...
                                <div class="col-md-12">
                                  <select class="select2 form-control select2-orange" data-dropdown-css-class="select2-orange" id="inputJenisKendaraan">
                                    ...
                                    <?php foreach ($jenis as $jen): ?>
                                      <option value="<?=$jen->JENIS_KENDARAAN?>" <?=$jen->JENIS_KENDARAAN == $key->JENIS_KENDARAAN ? 'selected':''?>><?=$jen->JENIS_KENDARAAN?><?=$jen->JENIS_KENDARAAN == 'Minibus'?'/Mobil':''?></option>
                                    <?php endforeach ?>
                                  </select>
                                </div>
                              </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-2">
                              <div class="row">
                                <div class="col-md-12">
                                  <input type="text" id="inputNoInventaris" class="form-control form-control-sm inputan" value="<?=$key->NO_INVENTARIS?>">
                                </div>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-2">
                              <div class="row">
                                <div class="col-md-12">
                                  <input type="text" id="inputNoTNKB" class="form-control form-control-sm inputan" value="<?=$key->NO_TNKB?>">
                                </div>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-2">
                              <div class="row">
                                <div class="col-md-12">
                                  <input type="text" id="inputMerk" class="form-control form-control-sm inputan" value="<?=$key->MERK?>">
                                </div>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-2">
                              <div class="row">
                                <div class="col-md-12">
                                  <input type="text" id="inputType" class="form-control form-control-sm inputan" value="<?=$key->TYPE?>">
                                </div>
                              </div>
                            </div>
                          </div>
                              ...
                              <table class="table table-hover table-valign-middle" width="100%">
                                ...
                                <tbody class="text-center">
                                    ...
                                    <td>
                                      ...
                                      <div id="manualBBM">
                                        <div class="form-group">
                                          <label>&nbsp;</label>
                                          <span class="form-control-icon">Rp</span>
                                          <input type="number" class="form-control form-control-search" id="inputBBMManual" value="<?=$key->MEDIA_UANG_BBM == 'Kasbon'?$key->TOTAL_UANG_BBM:'0'?>">
                                        </div>
                                      </div>
                                    </td>
                                    <td>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <div class="form-group">
                                        <label>&nbsp;</label>
                                        <span class="form-control-icon">Rp</span>
                                        <input type="number" class="form-control form-control-search" id="inputTOL" value="<?=$key->TOTAL_UANG_TOL == null || $key->TOTAL_UANG_TOL == '' ? '0':$key->TOTAL_UANG_TOL?>" <?=$key->MEDIA_UANG_TOL == 'Reimburse'?'readonly':''?>>
                                      </div>
                                    </td>
                                    <td>
                                      ...
                                      <select class="select2 form-control select2-orange" id="inputMediaTol" data-dropdown-css-class="select2-orange">
                                        <option value="Kasbon" <?=$key->MEDIA_UANG_TOL == 'Kasbon' ? 'selected':''?>>Kasbon</option>
                                        <option value="Voucher" disabled>Voucher</option>
                                        <option value="Reimburse" <?=$key->MEDIA_UANG_TOL == 'Reimburse' ? 'selected':''?>>Reimburse</option>
                                      </select>
                                    </td>
                                  </tr>
                                  <tr class="biayaKendaraanRental">
                                    ...
                                    <td><input type="number" class="form-control" id="inputBiayaKendaraan" value="<?=$key->TOTAL_UANG_KENDARAAN?>"></td>
                                    <td>
