                  ...
                  <div class="row">
                    ...
                    <div class="<?=$kasbon == 'BBM'?'':'col-md-2'?>">
                      <div class="form-group">
                        ...
                        <?php else: ?>
                          <input type="hidden" id="filJenis" value="-">
                        <?php endif ?>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <?php else:?>
                        <input type="hidden" id="inputJenis" value="-">
                      <?php endif ?>
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $('#btnTambahDebit').on('click', function(){
    ...
    var saveDebit = $('.saveDebit').ladda();
      ...
      setTimeout(function () {
        var inputDebit = $('#inputDebit').val();
        var inputId = $('#inputId').val();
        var inputJenis = $('#inputJenis').val();
        var inputJenisKasbon = '<?=$kasbon?>';
        if (inputJenis == '' || inputDebit == '') {
          Swal.fire("Lengkapi Datanya Terlebih Dahulu!","","warning")
        } else {
          $.ajax({
            type: 'post',
            data:{inputDebit, inputId, inputJenis, inputJenisKasbon},
            dataType: 'json',
            cache: false,
            async: true,
            url: 'saveDebit',
